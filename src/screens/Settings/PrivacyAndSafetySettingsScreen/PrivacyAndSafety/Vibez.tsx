...
const Vibez = () => {
    ...
    const renderBottomSheetContent = (type) => {
        const options = type === 'visibility' ? vibezOptions : commentOptions;
