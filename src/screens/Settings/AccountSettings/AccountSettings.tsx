...
const accountSettingsOptions = [
  ...
  },
  {
    ...
    options: [
      { id: 4, title: 'Feed preferences', link: 'FeedPreferences' },
      { id: 5, title: 'Interests', link: 'SearchInterests' },
      { id: 6, title: 'Autoplay', link: 'AutoPlay' },
    ],
  },
  {
    id: 7,
    section: 'Payments',
    options: [
      { id: 8, title: 'Payment cards', link: 'PaymentCards' },
      { id: 9, title: 'Withdrawal Banks', link: 'WithdrawalBank' },
    ],
  },
  {
    id: 10,
    ...
    options: [
      { id: 11, title: 'Account status', link: 'AccountStatus' },
