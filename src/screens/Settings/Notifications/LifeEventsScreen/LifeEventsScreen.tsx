...
// Define the props for the LifeEvents component
...
const LifeEventsScreen = () => {
    const renderItem: React.FC<{ item: LifeEvents }> = ({ item }) => (
        <SettingsListItem
            key={item.id}
            label={item.label}
    ...
    return (
        <View style={styles.container}>
            ...
            <Text style={styles.description}>
                These are notifications letting you know someone you follow is celebrating a special day.
            </Text>
            <FlatList
