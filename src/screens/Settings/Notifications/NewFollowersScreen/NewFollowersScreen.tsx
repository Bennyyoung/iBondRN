...
// Define the props for the NewFollowers component
...
const NewFollowersScreen = () => {
    const renderItem: React.FC<{ item: NewFollowers }> = ({ item }) => (
        <SettingsListItem
            key={item.id}
            label={item.label}
    ...
    return (
        <View style={styles.container}>
            ...
            <Text style={styles.description}>
                These are notifications when someone follows you or requests to follow your private account.
            </Text>
            <FlatList
