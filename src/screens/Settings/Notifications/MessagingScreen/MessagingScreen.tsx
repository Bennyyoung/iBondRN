...
// Define the props for the MessagingScreen component
...
const MessagingScreen = () => {
    ...
    return (
        <View style={styles.container}>
            ...
            <Text style={styles.description}>These are notifications letting you know you’ve received new messages</Text>
            <FlatList
